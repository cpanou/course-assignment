...
public class EmployeeMapper {
    ...
    private final Function<Employee, EmployeeResponse> toResponse = employee -> EmployeeResponse.builder()
            .id(employee.getId())
    ...
    private final Function<EmployeeRequest, Employee> fromRequest = employeeRequest -> Employee.builder()
